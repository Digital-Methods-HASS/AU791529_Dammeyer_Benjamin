...
date: 'created on 27 March 2026 and updated `r format(Sys.time(), "%d %B, %Y")`'
...
got_df# More information: https://cran.r-project.org/web/packages/stringr/vignettes/regular-expressions.html
```
